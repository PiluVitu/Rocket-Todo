...
interface TodoRowProps {
  ...
  setCompleteTask: (id: string, complete: boolean) => void
}

// TODO Passar as informções contidas em cada item da lista para seu respectivo lugar
...
export function TodoRow({
  ...
  function handleSetCheckedTask() {
    ...
    if (checked === true) {
      setChecked(false)
      setCompleteTask(id, (complete = false))
    }
  }
    ...
    return (
      <li className={styles.todoRow}>
        <Checkbox.Root
          ...
          checked={checked}
          onCheckedChange={handleSetCheckedTask}
        >
